...
public interface StoreService {
    ...
    public ResponseStoreDTO createStore(@NotNull CreateStoreDTO createStoreDTO);
    public ResponseStoreDTO update(@NotNull Long id, @NotNull UpdateStoreDTO updateStoreDTO);
    public boolean exists(@NotNull Long id);
    public boolean exists(@NotNull StoreNameAndCodeDTO storeNameAndCodeDTO);
