...
class EmployeeProposalShiftsSpecification {
    static Specification<EmployeeProposalShifts> hasStoreId(Long storeId) {
    ...
    static Specification<EmployeeProposalShifts> hasEmployeeId(Long employeeId) {
    ...
    static Specification<EmployeeProposalShifts> isBetweenDates(LocalDate startDate, LocalDate endDate){
