...
class EmployeeVacationSpecification {
    static Specification<EmployeeVacation> hasStoreId(Long storeId){
    ...
    static Specification<EmployeeVacation> hasEmployeeId(Long employeeId){
    ...
    static Specification<EmployeeVacation> hasYear(Integer year){
    ...
    static Specification<EmployeeVacation> hasMonth(Integer month){
