...
('DORADCA KLIENTA','Pełni rolę sprzedawcy'),
('DORADCA KLIENTA MANAGER','Pełni rolę sprzedawcy, a także wspomaga pracę zespołu Kierowników w danym sklepie'),
('KASJER','Odpowiada za przyjmowanie płatności na kasie'),
('MAGAZYNIER','Odpowiada za przyjęcie i odsyłkę towaru na sklepie');